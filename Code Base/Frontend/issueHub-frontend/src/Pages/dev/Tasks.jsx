...
import { DevShell, PriorityTag, StatusTag, C } from "../../components/dev/DevUI";
  ...
  return (
    <DevShell>
      ...
      <div style={{ fontSize:13, color:C.muted, marginBottom:24 }}>
        Personal task tracker — sorted by {sort}
      </div>
        ...
        return (
          <div key={issue.id}
            ...
            style={{ display:"flex", alignItems:"center", gap:14,
              padding:"12px 16px", background:C.surface, border:"1px solid",
            ...
            <span style={{ fontSize:12, color: od && !done ? "#ef4444" : C.muted }}>
